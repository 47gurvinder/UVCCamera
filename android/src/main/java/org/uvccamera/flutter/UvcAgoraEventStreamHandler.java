 ...
 */
/* package-private */ class UvcAgoraEventStreamHandler implements EventChannel.StreamHandler {

    /**
     * Log tag
     */
    private static final String TAG = UvcAgoraEventStreamHandler.class.getCanonicalName();
