...
/**
 * Camera stream event stream handler
 */
/* package-private */ class UvcCameraStreamEventStreamHandler implements EventChannel.StreamHandler {

    /**
     * Log tag
     */
    private static final String TAG = UvcCameraStreamEventStreamHandler.class.getCanonicalName();
